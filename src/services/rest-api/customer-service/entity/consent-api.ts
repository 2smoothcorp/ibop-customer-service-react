...
export const ConsentApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        consentGetAnsweredCorparateIdGet: async (corparateId: string, formId?: string, xPortalToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        consentGetQuestionFormIdGet: async (formId: string, xPortalToken?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        consentSaveCorparateIdPost: async (corparateId: string, xPortalToken?: string, consentSaveCorparateIdPostRequest?: ConsentSaveCorparateIdPostRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'corparateId' is not null or undefined
...
export const ConsentApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async consentGetAnsweredCorparateIdGet(corparateId: string, formId?: string, xPortalToken?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ConsentAnsweredOutputDataResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.consentGetAnsweredCorparateIdGet(corparateId, formId, xPortalToken, options);
         ...
         * @throws {RequiredError}
         */
        async consentGetQuestionFormIdGet(formId: string, xPortalToken?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ConsentQuestionOutputDataResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.consentGetQuestionFormIdGet(formId, xPortalToken, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async consentSaveCorparateIdPost(corparateId: string, xPortalToken?: string, consentSaveCorparateIdPostRequest?: ConsentSaveCorparateIdPostRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.consentSaveCorparateIdPost(corparateId, xPortalToken, consentSaveCorparateIdPostRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const ConsentApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        consentGetAnsweredCorparateIdGet(requestParameters: ConsentApiConsentGetAnsweredCorparateIdGetRequest, options?: AxiosRequestConfig): AxiosPromise<ConsentAnsweredOutputDataResponse> {
            return localVarFp.consentGetAnsweredCorparateIdGet(requestParameters.corparateId, requestParameters.formId, requestParameters.xPortalToken, options).then((request) => request(axios, basePath));
        },
        /**
         * 
        ...
        consentGetQuestionFormIdGet(requestParameters: ConsentApiConsentGetQuestionFormIdGetRequest, options?: AxiosRequestConfig): AxiosPromise<ConsentQuestionOutputDataResponse> {
            return localVarFp.consentGetQuestionFormIdGet(requestParameters.formId, requestParameters.xPortalToken, options).then((request) => request(axios, basePath));
        },
        /**
         * 
        ...
        consentSaveCorparateIdPost(requestParameters: ConsentApiConsentSaveCorparateIdPostRequest, options?: AxiosRequestConfig): AxiosPromise<void> {
            return localVarFp.consentSaveCorparateIdPost(requestParameters.corparateId, requestParameters.xPortalToken, requestParameters.consentSaveCorparateIdPostRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ConsentApi extends BaseAPI {
    ...
    public consentGetAnsweredCorparateIdGet(requestParameters: ConsentApiConsentGetAnsweredCorparateIdGetRequest, options?: AxiosRequestConfig) {
        return ConsentApiFp(this.configuration).consentGetAnsweredCorparateIdGet(requestParameters.corparateId, requestParameters.formId, requestParameters.xPortalToken, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public consentGetQuestionFormIdGet(requestParameters: ConsentApiConsentGetQuestionFormIdGetRequest, options?: AxiosRequestConfig) {
        return ConsentApiFp(this.configuration).consentGetQuestionFormIdGet(requestParameters.formId, requestParameters.xPortalToken, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public consentSaveCorparateIdPost(requestParameters: ConsentApiConsentSaveCorparateIdPostRequest, options?: AxiosRequestConfig) {
        return ConsentApiFp(this.configuration).consentSaveCorparateIdPost(requestParameters.corparateId, requestParameters.xPortalToken, requestParameters.consentSaveCorparateIdPostRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
