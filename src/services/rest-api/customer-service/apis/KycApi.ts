...
export class KycApi extends runtime.BaseAPI {
    ...
    /**
     */
    async kycSaveCorporateIdPostRaw(requestParameters: KycSaveCorporateIdPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters.corporateId === null || requestParameters.corporateId === undefined) {
    ...
    /**
     */
    async kycSaveCorporateIdPost(requestParameters: KycSaveCorporateIdPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.kycSaveCorporateIdPostRaw(requestParameters, initOverrides);
    }
