...
import {
    ...
    KycGetAllOutputDataResponseFromJSON,
    KycGetAllOutputDataResponseToJSON,
...
export interface KycGetRevaluateAllGetRequest {
    corporateId?: string;
    referenceId?: string;
    name?: string;
    startDate?: Date;
...
export class KycApi extends runtime.BaseAPI {
    ...
    /**
     */
    async kycGetAllGetRaw(requestParameters: KycGetAllGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<KycGetAllOutputDataResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => KycGetAllOutputDataResponseFromJSON(jsonValue));
    }

    /**
     */
    async kycGetAllGet(requestParameters: KycGetAllGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<KycGetAllOutputDataResponse> {
    ...
    /**
     */
    async kycGetRevaluateAllGetRaw(requestParameters: KycGetRevaluateAllGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<KycGetAllOutputDataResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async kycGetRevaluateAllGet(requestParameters: KycGetRevaluateAllGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<KycGetAllOutputDataResponse> {
        const response = await this.kycGetRevaluateAllGetRaw(requestParameters, initOverrides);
        return await response.value();
    }
