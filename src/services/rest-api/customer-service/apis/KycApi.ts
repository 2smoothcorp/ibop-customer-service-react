...
export class KycApi extends runtime.BaseAPI {
    ...
    /**
     */
    async kycGetRevaluateAllGetRaw(requestParameters: KycGetRevaluateAllGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<KycGetAllOutputListDataResponse>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async kycGetRevaluateAllGet(requestParameters: KycGetRevaluateAllGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<KycGetAllOutputListDataResponse> {
