...
import type {
  ...
  KycPersonalInfoOutputListDataResponse,
  KycResultResponseDataResponse,
  KycSpouseInfoOutputDataResponse,
  KycUpdateAddressInfoCorporateIdPostRequest,
...
import {
    ...
    KycPersonalInfoOutputListDataResponseFromJSON,
    KycPersonalInfoOutputListDataResponseToJSON,
    ...
    KycUpdateAddressInfoCorporateIdPostRequestFromJSON,
    KycUpdateAddressInfoCorporateIdPostRequestToJSON,
...
export interface KycUpdateAddressInfoCorporateIdPostOperationRequest {
    corporateId: string;
    xPortalToken?: string;
    kycUpdateAddressInfoCorporateIdPostRequest?: KycUpdateAddressInfoCorporateIdPostRequest;
}
...
export class KycApi extends runtime.BaseAPI {
    ...
    /**
     */
    async kycGetAllGetRaw(requestParameters: KycGetAllGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<KycPersonalInfoOutputListDataResponse>> {
        const queryParameters: any = {};
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => KycPersonalInfoOutputListDataResponseFromJSON(jsonValue));
    }

    /**
     */
    async kycGetAllGet(requestParameters: KycGetAllGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<KycPersonalInfoOutputListDataResponse> {
    ...
    /**
     */
    async kycUpdateAddressInfoCorporateIdPostRaw(requestParameters: KycUpdateAddressInfoCorporateIdPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BaseResponse>> {
        if (requestParameters.corporateId === null || requestParameters.corporateId === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: KycUpdateAddressInfoCorporateIdPostRequestToJSON(requestParameters.kycUpdateAddressInfoCorporateIdPostRequest),
        }, initOverrides);
    ...
    /**
     */
    async kycUpdateAddressInfoCorporateIdPost(requestParameters: KycUpdateAddressInfoCorporateIdPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BaseResponse> {
