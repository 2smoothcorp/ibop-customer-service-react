...
import type {
  ...
  CustomerProfileCustomerInformationRejectCorporateIdPostRequest,
...
import {
    ...
    CustomerProfileCustomerInformationRejectCorporateIdPostRequestFromJSON,
    CustomerProfileCustomerInformationRejectCorporateIdPostRequestToJSON,
...
export interface CustomerProfileCustomerInfoEditListGetRequest {
    corporateID?: string;
    referenceID?: string;
    fullName?: string;
    emailNumber?: string;
...
export interface CustomerProfileCustomerInformationApproveCorporateIdPostRequest {
    corporateId: string;
    xPortalToken?: string;
}
...
export interface CustomerProfileCustomerInformationRejectCorporateIdPostOperationRequest {
    corporateId: string;
    xPortalToken?: string;
    customerProfileCustomerInformationRejectCorporateIdPostRequest?: CustomerProfileCustomerInformationRejectCorporateIdPostRequest;
}
...
export class CustomerProfileV2Api extends runtime.BaseAPI {
    ...
    /**
     * Customer Information Edit List v2
     */
    async customerProfileCustomerInfoEditListGetRaw(requestParameters: CustomerProfileCustomerInfoEditListGetRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CustomerInfoListResponsePagination>> {
        ...
        const response = await this.request({
            path: `/customer-profile/CustomerInfoEditList`,
            method: 'GET',
     ...
     * Customer Information Edit List v2
     */
    async customerProfileCustomerInfoEditListGet(requestParameters: CustomerProfileCustomerInfoEditListGetRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CustomerInfoListResponsePagination> {
        const response = await this.customerProfileCustomerInfoEditListGetRaw(requestParameters, initOverrides);
    ...
    /**
     * Approve Update CustomerInfo
     */
    async customerProfileCustomerInformationApproveCorporateIdPostRaw(requestParameters: CustomerProfileCustomerInformationApproveCorporateIdPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BaseResponse>> {
        if (requestParameters.corporateId === null || requestParameters.corporateId === undefined) {
            throw new runtime.RequiredError('corporateId','Required parameter requestParameters.corporateId was null or undefined when calling customerProfileCustomerInformationApproveCorporateIdPost.');
        }
        ...
        const response = await this.request({
            path: `/customer-profile/CustomerInformation/Approve/{corporateId}`.replace(`{${"corporateId"}}`, encodeURIComponent(String(requestParameters.corporateId))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
     ...
     * Approve Update CustomerInfo
     */
    async customerProfileCustomerInformationApproveCorporateIdPost(requestParameters: CustomerProfileCustomerInformationApproveCorporateIdPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BaseResponse> {
        const response = await this.customerProfileCustomerInformationApproveCorporateIdPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
    ...
    /**
     * Reject Update CustomerInfo
     */
    async customerProfileCustomerInformationRejectCorporateIdPostRaw(requestParameters: CustomerProfileCustomerInformationRejectCorporateIdPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<BaseResponse>> {
        if (requestParameters.corporateId === null || requestParameters.corporateId === undefined) {
            throw new runtime.RequiredError('corporateId','Required parameter requestParameters.corporateId was null or undefined when calling customerProfileCustomerInformationRejectCorporateIdPost.');
        }
        ...
        const response = await this.request({
            path: `/customer-profile/CustomerInformation/Reject/{corporateId}`.replace(`{${"corporateId"}}`, encodeURIComponent(String(requestParameters.corporateId))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: CustomerProfileCustomerInformationRejectCorporateIdPostRequestToJSON(requestParameters.customerProfileCustomerInformationRejectCorporateIdPostRequest),
        }, initOverrides);
     ...
     * Reject Update CustomerInfo
     */
    async customerProfileCustomerInformationRejectCorporateIdPost(requestParameters: CustomerProfileCustomerInformationRejectCorporateIdPostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<BaseResponse> {
        const response = await this.customerProfileCustomerInformationRejectCorporateIdPostRaw(requestParameters, initOverrides);
        return await response.value();
    }
