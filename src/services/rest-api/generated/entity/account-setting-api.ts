...
export const AccountSettingApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        accountSettingCreatePost: async (UNKNOWN_PARAMETER_NAME?: , accountSettingCreatePostRequest?: AccountSettingCreatePostRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        accountSettingGet: async (prefix?: string, newPrefix?: string, status?: string, remark?: string, logUser?: string, UNKNOWN_PARAMETER_NAME?: , options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        accountSettingUpdatePut: async (UNKNOWN_PARAMETER_NAME?: , accountSettingCreatePostRequest?: AccountSettingCreatePostRequest, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const AccountSettingApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async accountSettingCreatePost(UNKNOWN_PARAMETER_NAME?: , accountSettingCreatePostRequest?: AccountSettingCreatePostRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AccountSettingSPListDataResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.accountSettingCreatePost(UNKNOWN_PARAMETER_NAME, accountSettingCreatePostRequest, options);
         ...
         * @throws {RequiredError}
         */
        async accountSettingGet(prefix?: string, newPrefix?: string, status?: string, remark?: string, logUser?: string, UNKNOWN_PARAMETER_NAME?: , options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AccountSettingSPListDataResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.accountSettingGet(prefix, newPrefix, status, remark, logUser, UNKNOWN_PARAMETER_NAME, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * 
         ...
         * @throws {RequiredError}
         */
        async accountSettingUpdatePut(UNKNOWN_PARAMETER_NAME?: , accountSettingCreatePostRequest?: AccountSettingCreatePostRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AccountSettingSPListDataResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.accountSettingUpdatePut(UNKNOWN_PARAMETER_NAME, accountSettingCreatePostRequest, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
    }
};
...
export const AccountSettingApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
        ...
        accountSettingCreatePost(requestParameters: AccountSettingApiAccountSettingCreatePostRequest = {}, options?: AxiosRequestConfig): AxiosPromise<AccountSettingSPListDataResponse> {
            return localVarFp.accountSettingCreatePost(requestParameters.UNKNOWN_PARAMETER_NAME, requestParameters.accountSettingCreatePostRequest, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary API for getting all account setting as list
        ...
        accountSettingGet(requestParameters: AccountSettingApiAccountSettingGetRequest = {}, options?: AxiosRequestConfig): AxiosPromise<AccountSettingSPListDataResponse> {
            return localVarFp.accountSettingGet(requestParameters.prefix, requestParameters.newPrefix, requestParameters.status, requestParameters.remark, requestParameters.logUser, requestParameters.UNKNOWN_PARAMETER_NAME, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary API for updating account setting
        ...
        accountSettingUpdatePut(requestParameters: AccountSettingApiAccountSettingUpdatePutRequest = {}, options?: AxiosRequestConfig): AxiosPromise<AccountSettingSPListDataResponse> {
            return localVarFp.accountSettingUpdatePut(requestParameters.UNKNOWN_PARAMETER_NAME, requestParameters.accountSettingCreatePostRequest, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class AccountSettingApi extends BaseAPI {
    ...
    public accountSettingCreatePost(requestParameters: AccountSettingApiAccountSettingCreatePostRequest = {}, options?: AxiosRequestConfig) {
        return AccountSettingApiFp(this.configuration).accountSettingCreatePost(requestParameters.UNKNOWN_PARAMETER_NAME, requestParameters.accountSettingCreatePostRequest, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public accountSettingGet(requestParameters: AccountSettingApiAccountSettingGetRequest = {}, options?: AxiosRequestConfig) {
        return AccountSettingApiFp(this.configuration).accountSettingGet(requestParameters.prefix, requestParameters.newPrefix, requestParameters.status, requestParameters.remark, requestParameters.logUser, requestParameters.UNKNOWN_PARAMETER_NAME, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public accountSettingUpdatePut(requestParameters: AccountSettingApiAccountSettingUpdatePutRequest = {}, options?: AxiosRequestConfig) {
        return AccountSettingApiFp(this.configuration).accountSettingUpdatePut(requestParameters.UNKNOWN_PARAMETER_NAME, requestParameters.accountSettingCreatePostRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
