...
export const VerificationApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        verificationGetAllGet: async (corparateId?: string, name?: string, refId?: string, getByRefId?: boolean, startDate?: string, endDate?: string, status?: Array<string>, isEmailSms?: boolean, channel?: Array<string>, customerType?: Array<string>, pageIndex?: number, pageSize?: number, sortField?: string, sortDirection?: string, UNKNOWN_PARAMETER_NAME?: , options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const VerificationApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async verificationGetAllGet(corparateId?: string, name?: string, refId?: string, getByRefId?: boolean, startDate?: string, endDate?: string, status?: Array<string>, isEmailSms?: boolean, channel?: Array<string>, customerType?: Array<string>, pageIndex?: number, pageSize?: number, sortField?: string, sortDirection?: string, UNKNOWN_PARAMETER_NAME?: , options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<VerifyRequestVerifyRequestOutputPagination>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.verificationGetAllGet(corparateId, name, refId, getByRefId, startDate, endDate, status, isEmailSms, channel, customerType, pageIndex, pageSize, sortField, sortDirection, UNKNOWN_PARAMETER_NAME, options);
