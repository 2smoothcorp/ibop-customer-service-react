...
import { getAddressByCurrent } from "./addressByCurrent.action";
...
export default function AddressByCurrent() {
    ...
    return (
        <>
            ...
            />
            <ContentLoading
                isLoading={!getAddressByCurrentState.data && getAddressByCurrentState.error === undefined && !isReady}
                error={getAddressByCurrentState.error || null}
                hight={184}
            >
